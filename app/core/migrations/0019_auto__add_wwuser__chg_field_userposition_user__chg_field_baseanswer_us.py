...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'UserPosition.user'
        db.alter_column(u'core_userposition', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True))

        # Changing field 'BaseAnswer.user'
        db.alter_column(u'core_baseanswer', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'UserProfile.user'
        db.alter_column(u'core_userprofile', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True))
    ...
    models = {
        ...
        u'core.baseanswer': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.WWUser']"})
        },
        ...
        u'core.userposition': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.WWUser']", 'unique': 'True'})
        },
        u'core.userprofile': {
