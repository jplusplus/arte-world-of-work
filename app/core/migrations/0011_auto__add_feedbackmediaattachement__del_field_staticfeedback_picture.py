...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FeedbackMediaAttachement'
        db.create_table(u'core_feedbackmediaattachement', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('picture', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True)),
            ('feedback', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.StaticFeedback'], unique=True)),
        ))
        db.send_create_signal(u'core', ['FeedbackMediaAttachement'])
    ...
    def backwards(self, orm):
        # Deleting model 'FeedbackMediaAttachement'
        db.delete_table(u'core_feedbackmediaattachement')
    ...
    models = {
        ...
        u'core.feedbackmediaattachement': {
            'Meta': {'object_name': 'FeedbackMediaAttachement'},
            'feedback': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['core.StaticFeedback']", 'unique': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
