...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaseAnswer.content_type'
        db.add_column(u'core_baseanswer', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['contenttypes.ContentType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BaseAnswer.content_type'
        db.delete_column(u'core_baseanswer', 'content_type_id')
