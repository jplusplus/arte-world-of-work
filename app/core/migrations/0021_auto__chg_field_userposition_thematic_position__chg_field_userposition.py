...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserPosition.thematic_position'
        db.alter_column(u'core_userposition', 'thematic_position', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'UserPosition.element_position'
        db.alter_column(u'core_userposition', 'element_position', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'UserPosition.user'
        db.alter_column(u'core_userposition', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['authentication.WWUser'], unique=True))
        ...
        db.alter_column(u'core_userprofile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['authentication.WWUser'], unique=True))

    def backwards(self, orm):

        # Changing field 'UserPosition.thematic_position'
        db.alter_column(u'core_userposition', 'thematic_position', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'UserPosition.element_position'
        db.alter_column(u'core_userposition', 'element_position', self.gf('django.db.models.fields.PositiveIntegerField')())
