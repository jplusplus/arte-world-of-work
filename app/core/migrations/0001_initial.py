...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_baseanswer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.BaseQuestion'], unique=True)),
        ))
        db.send_create_signal(u'core', ['BaseAnswer'])
        ...
        # Adding model 'UserProfileAnswer'
        db.create_table(u'core_userprofileanswer', (
            (u'baseanswer_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.BaseAnswer'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'core', ['UserProfileAnswer'])

        # Adding model 'UserCountryAnswer'
        db.create_table(u'core_usercountryanswer', (
            (u'userprofileanswer_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.UserProfileAnswer'], unique=True, primary_key=True)),
            ('value', self.gf('django_countries.fields.CountryField')(max_length=2)),
        ))
        db.send_create_signal(u'core', ['UserCountryAnswer'])

        # Adding model 'UserAgeAnswer'
        db.create_table(u'core_userageanswer', (
            (u'userprofileanswer_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.UserProfileAnswer'], unique=True, primary_key=True)),
            ('value', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'core', ['UserAgeAnswer'])
        ...
        # Adding model 'UserProfileQuestion'
        db.create_table(u'core_userprofilequestion', (
        ...
        db.send_create_signal(u'core', ['UserProfileQuestion'])

        # Adding model 'UserAgeQuestion'
        db.create_table(u'core_useragequestion', (
            (u'userprofilequestion_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.UserProfileQuestion'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'core', ['UserAgeQuestion'])

        # Adding model 'UserCountryQuestion'
        db.create_table(u'core_usercountryquestion', (
            (u'userprofilequestion_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.UserProfileQuestion'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'core', ['UserCountryQuestion'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'core_baseanswer')
        ...
        # Deleting model 'UserProfileAnswer'
        db.delete_table(u'core_userprofileanswer')

        # Deleting model 'UserCountryAnswer'
        db.delete_table(u'core_usercountryanswer')

        # Deleting model 'UserAgeAnswer'
        db.delete_table(u'core_userageanswer')

        # Deleting model 'BaseQuestion'
        db.delete_table(u'core_basequestion')

        # Deleting model 'UserProfileQuestion'
        db.delete_table(u'core_userprofilequestion')

        # Deleting model 'UserAgeQuestion'
        db.delete_table(u'core_useragequestion')

        # Deleting model 'UserCountryQuestion'
        db.delete_table(u'core_usercountryquestion')
