...
model_name = lambda obj: obj.__class__.__name__.lower()
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        ThematicElement = orm['core.thematicelement']
        TextSelection   = orm['core.textselectionquestion']
        TextRadio       = orm['core.textradioquestion']

        MediaSelection = orm['core.mediaselectionquestion']
        MediaRadio     = orm['core.mediaradioquestion']

        MediaChoice    = orm['core.mediachoicefield']
        TextChoice     = orm['core.textchoicefield']
        mapping = {
            TextSelection: MediaSelection,
            TextRadio: MediaRadio
        }

        for FromModel in mapping.keys():
