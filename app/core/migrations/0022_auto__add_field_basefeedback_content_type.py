...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaseFeedback.content_type'
        db.add_column(u'core_basefeedback', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['contenttypes.ContentType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BaseFeedback.content_type'
        db.delete_column(u'core_basefeedback', 'content_type_id')
