...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StaticFeedback.question'
        db.alter_column(u'core_staticfeedback', 'question_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.BaseQuestion'], unique=True, null=True))
        # Adding unique constraint on 'StaticFeedback', fields ['question']
        db.create_unique(u'core_staticfeedback', ['question_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'StaticFeedback', fields ['question']
        db.delete_unique(u'core_staticfeedback', ['question_id'])


        # Changing field 'StaticFeedback.question'
        db.alter_column(u'core_staticfeedback', 'question_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.BaseQuestion'], null=True))
    ...
    models = {
        ...
        u'core.staticfeedback': {
            ...
            'picture': ('sorl.thumbnail.fields.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'question': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['core.BaseQuestion']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
