...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Thematic.outro'
        db.delete_column(u'core_thematic', 'outro')

        # Adding field 'Thematic.outro_description'
        db.add_column(u'core_thematic', 'outro_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Thematic.outro_button_label'
        db.add_column(u'core_thematic', 'outro_button_label',
                      self.gf('django.db.models.fields.CharField')(default=u'Skip', max_length=120, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Thematic.outro'
        db.add_column(u'core_thematic', 'outro',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Thematic.outro_description'
        db.delete_column(u'core_thematic', 'outro_description')

        # Deleting field 'Thematic.outro_button_label'
        db.delete_column(u'core_thematic', 'outro_button_label')
    ...
    models = {
        ...
        u'core.thematic': {
            ...
            'outro_button_label': ('django.db.models.fields.CharField', [], {'default': "u'Skip'", 'max_length': '120', 'null': 'True', 'blank': 'True'}),
            'outro_description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
