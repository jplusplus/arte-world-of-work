...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Thematic.slug'
        db.add_column(u'core_thematic', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=250, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Thematic.slug'
        db.delete_column(u'core_thematic', 'slug')
