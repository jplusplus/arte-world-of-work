...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserAgeQuestion.validate_button_label'
        db.add_column(u'core_useragequestion', 'validate_button_label',
                      self.gf('django.db.models.fields.CharField')(default=u'Done', max_length=120),
                      keep_default=False)

        # Deleting field 'Thematic.intro_data_button_title'
        db.delete_column(u'core_thematic', 'intro_data_button_title')

        # Adding field 'Thematic.intro_button_label'
        db.add_column(u'core_thematic', 'intro_button_label',
                      self.gf('django.db.models.fields.CharField')(default=u'See the data', max_length=120),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserAgeQuestion.validate_button_label'
        db.delete_column(u'core_useragequestion', 'validate_button_label')

        # Adding field 'Thematic.intro_data_button_title'
        db.add_column(u'core_thematic', 'intro_data_button_title',
                      self.gf('django.db.models.fields.TextField')(default='See the data'),
                      keep_default=False)

        # Deleting field 'Thematic.intro_button_label'
        db.delete_column(u'core_thematic', 'intro_button_label')
    ...
    models = {
        ...
        u'core.thematic': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'intro_button_label': ('django.db.models.fields.CharField', [], {'default': "u'See the data'", 'max_length': '120'}),
