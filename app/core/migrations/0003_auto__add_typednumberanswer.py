...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TypedNumberAnswer'
        db.create_table(u'core_typednumberanswer', (
            (u'numberanswer_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.NumberAnswer'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'core', ['TypedNumberAnswer'])


    def backwards(self, orm):
        # Deleting model 'TypedNumberAnswer'
        db.delete_table(u'core_typednumberanswer')
