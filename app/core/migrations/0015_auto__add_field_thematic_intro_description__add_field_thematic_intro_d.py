...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Thematic.intro_description'
        db.add_column(u'core_thematic', 'intro_description',
                      self.gf('django.db.models.fields.TextField')(default='Change this description'),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Thematic.intro_description'
        db.delete_column(u'core_thematic', 'intro_description')
    ...
    models = {
        ...
        u'core.thematic': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'intro_data_button_title': ('django.db.models.fields.TextField', [], {}),
