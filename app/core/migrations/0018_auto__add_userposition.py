...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserPosition'
        db.create_table(u'core_userposition', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
            ('thematic_position', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('element_position', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal(u'core', ['UserPosition'])


    def backwards(self, orm):
        # Deleting model 'UserPosition'
        db.delete_table(u'core_userposition')
