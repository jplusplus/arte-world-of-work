...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StaticFeedback.question'
        db.add_column(u'core_staticfeedback', 'question',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.BaseQuestion'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StaticFeedback.question'
        db.delete_column(u'core_staticfeedback', 'question_id')
    ...
    models = {
        ...
        u'core.staticfeedback': {
            ...
            'picture': ('sorl.thumbnail.fields.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'question': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.BaseQuestion']", 'null': 'True', 'blank': 'True'}),
