...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Thematic.intro_button_label'
        db.alter_column(u'core_thematic', 'intro_button_label', self.gf('django.db.models.fields.CharField')(max_length=120, null=True))

    def backwards(self, orm):

        # Changing field 'Thematic.intro_button_label'
        db.alter_column(u'core_thematic', 'intro_button_label', self.gf('django.db.models.fields.CharField')(max_length=120))
