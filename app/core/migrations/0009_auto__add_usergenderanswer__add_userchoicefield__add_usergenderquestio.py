...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserGenderAnswer'
        db.create_table(u'core_usergenderanswer', (
        ...
        db.send_create_signal(u'core', ['UserGenderAnswer'])

        # Adding model 'UserChoiceField'
        db.create_table(u'core_userchoicefield', (
            ...
            ('value', self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True)),
        ))
        db.send_create_signal(u'core', ['UserChoiceField'])

        # Adding model 'UserGenderQuestion'
        db.create_table(u'core_usergenderquestion', (
        ...
        db.send_create_signal(u'core', ['UserGenderQuestion'])
    ...
    def backwards(self, orm):
        # Deleting model 'UserGenderAnswer'
        db.delete_table(u'core_usergenderanswer')

        # Deleting model 'UserChoiceField'
        db.delete_table(u'core_userchoicefield')

        # Deleting model 'UserGenderQuestion'
        db.delete_table(u'core_usergenderquestion')
