...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionMediaAttachement.vine_url'
        db.add_column(u'core_questionmediaattachement', 'vine_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionMediaAttachement.vine_url'
        db.delete_column(u'core_questionmediaattachement', 'vine_url')
