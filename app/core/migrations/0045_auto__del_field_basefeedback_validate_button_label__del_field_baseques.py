...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BaseFeedback.validate_button_label'
        db.delete_column(u'core_basefeedback', 'validate_button_label')
    ...
    def backwards(self, orm):
        # Adding field 'BaseFeedback.validate_button_label'
        db.add_column(u'core_basefeedback', 'validate_button_label',
