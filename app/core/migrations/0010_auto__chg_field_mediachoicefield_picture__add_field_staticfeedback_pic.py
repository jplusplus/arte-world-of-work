...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MediaChoiceField.picture'
        db.alter_column(u'core_mediachoicefield', 'picture', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True))
        # Adding field 'StaticFeedback.picture'
        db.add_column(u'core_staticfeedback', 'picture',
                      self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'QuestionMediaAttachement.picture'
        db.alter_column(u'core_questionmediaattachement', 'picture', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'MediaChoiceField.picture'
        db.alter_column(u'core_mediachoicefield', 'picture', self.gf('sorl.thumbnail.fields.ImageField')(default='CHANGE THIS VALUE', max_length=100))
        # Deleting field 'StaticFeedback.picture'
        db.delete_column(u'core_staticfeedback', 'picture')


        # Changing field 'QuestionMediaAttachement.picture'
        db.alter_column(u'core_questionmediaattachement', 'picture', self.gf('sorl.thumbnail.fields.ImageField')(default='CHANGE THIS VALUE', max_length=100))
