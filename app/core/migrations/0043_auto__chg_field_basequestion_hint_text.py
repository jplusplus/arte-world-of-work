...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BaseQuestion.hint_text'
        db.alter_column(u'core_basequestion', 'hint_text', self.gf('django.db.models.fields.CharField')(max_length=120, null=True))

    def backwards(self, orm):

        # Changing field 'BaseQuestion.hint_text'
        db.alter_column(u'core_basequestion', 'hint_text', self.gf('django.db.models.fields.CharField')(default='Enter your answer', max_length=120))
