...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_thematic', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=120)),
        ))
        db.send_create_signal(u'core', ['Thematic'])

        # Adding model 'ThematicElement'
        db.create_table(u'core_thematicelement', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('thematic', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Thematic'], null=True)),
            ('position', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'core', ['ThematicElement'])

        # Adding model 'BooleanQuestion'
        db.create_table(u'core_booleanquestion', (
        ...
        db.send_create_signal(u'core', ['BooleanQuestion'])


    def backwards(self, orm):
        # Deleting model 'Thematic'
        db.delete_table(u'core_thematic')

        # Deleting model 'ThematicElement'
        db.delete_table(u'core_thematicelement')

        # Deleting model 'BooleanQuestion'
        db.delete_table(u'core_booleanquestion')
    ...
    models = {
        ...
        u'core.thematicelement': {
            'Meta': {'object_name': 'ThematicElement'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
