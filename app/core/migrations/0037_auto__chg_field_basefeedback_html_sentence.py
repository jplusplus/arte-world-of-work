...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BaseFeedback.html_sentence'
        db.alter_column(u'core_basefeedback', 'html_sentence', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'BaseFeedback.html_sentence'
        db.alter_column(u'core_basefeedback', 'html_sentence', self.gf('django.db.models.fields.CharField')(max_length=120))
