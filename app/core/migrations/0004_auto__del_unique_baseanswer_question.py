...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'BaseAnswer', fields ['question']
        db.delete_unique(u'core_baseanswer', ['question_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'BaseAnswer', fields ['question']
        db.create_unique(u'core_baseanswer', ['question_id'])
