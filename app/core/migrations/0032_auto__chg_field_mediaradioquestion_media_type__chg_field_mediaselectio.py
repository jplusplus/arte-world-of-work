...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MediaRadioQuestion.media_type'
        db.alter_column(u'core_mediaradioquestion', 'media_type', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'MediaSelectionQuestion.media_type'
        db.alter_column(u'core_mediaselectionquestion', 'media_type', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

    def backwards(self, orm):

        # Changing field 'MediaRadioQuestion.media_type'
        db.alter_column(u'core_mediaradioquestion', 'media_type', self.gf('django.db.models.fields.CharField')(default='image', max_length=15))

        # Changing field 'MediaSelectionQuestion.media_type'
        db.alter_column(u'core_mediaselectionquestion', 'media_type', self.gf('django.db.models.fields.CharField')(default='image', max_length=15))
